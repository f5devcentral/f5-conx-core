...
export const atcMetaData = {
    ...
    do: {
        ...
        parentSchema: 'https://raw.githubusercontent.com/F5Networks/f5-declarative-onboarding/main/src/schema/latest/remote.schema.json',
        examples: 'https://github.com/F5Networks/f5-declarative-onboarding/tree/main/examples'
    },
    ts: {
        endPoints: {
